...
//******************************************************************************
    ...
    var scwDateOutputFormat  = 'YYYY/M/DD'; // e.g. 'MMM-DD-YYYY' for the US
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #4E9CE9;}'  +
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #9999CC;'   +
                                        'color:             #CCCCFF;}'  +
            '/* Week number heading */'                                 +
            'td.scwWeekNumberHead       {color:             #4E9CE9;}'  +
            '/* Week day headings */'                                   +
            ...
            'td.scwCellsExMonth         {background-color:  #CCCCCC;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'td.scwNow                  {background-color:  #4E9CE9;'   +
                                        'color:             #FFFFFF;}'  +
            '/* Clear Button */'                                        +
            ...
            'td.scwCellsExMonthDisabled {background-color:  #999999;'   +
                                        'color:             #666666;}'  +
            'td.scwNowDisabled          {background-color:  #627706;'   +
                                        'color:             #FFFFFF;}'  +
        '</style>'
                    );
